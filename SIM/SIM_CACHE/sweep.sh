...
$RTL/CPU/CPU_CACHE/ICACHE/ICACHE.sv $RTL/CPU/CPU_CACHE/DCACHE/DCACHE.sv $RTL/CPU/CPU_CACHE/CACHE_PORT_ARB/CACHE_PORT_ARB.sv $RTL/CPU/CPU_CACHE/CPU_CACHE/CPU_CACHE.sv \
...
"6#D\$ 256 sets (16B block, stays inside a page)#-GDC_SETS=256 -GDC_BLOCK=16 -GMEM_WORDS=65536"
"7#block 16B#-GDC_BLOCK=16 -GIC_BLOCK=16"
"8#block 32B#-GDC_BLOCK=32 -GIC_BLOCK=32"
"9#block 128B (32 sets, stays inside a page)#-GDC_BLOCK=128 -GIC_BLOCK=128 -GDC_SETS=32 -GIC_SETS=32 -GMEM_WORDS=32768"
...
"17#large D\$ (256 sets x 8 ways x 16B = 32KiB)#-GDC_SETS=256 -GDC_WAYS=8 -GDC_BLOCK=16 -GMEM_WORDS=262144"
