...
RTL=../../RTL
SRCS="$RTL/CACHE/CACHE_TAG_ARRAY/CACHE_TAG_ARRAY.sv $RTL/CACHE/CACHE_DATA_ARRAY/CACHE_DATA_ARRAY.sv \
$RTL/CACHE/ICACHE/ICACHE.sv $RTL/CACHE/DCACHE/DCACHE.sv $RTL/CACHE/CPU_CACHE/CPU_CACHE.sv \
