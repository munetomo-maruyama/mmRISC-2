...
"16#CPU/CPU_CACHE/CACHE_DATA_ARRAY/CACHE_DATA_ARRAY.sv#s/mem\[wr_way\]\[wr_addr\]/mem[0][wr_addr]/#1#3#data array: writes always go to way 0"
...
run_one() {
    ...
    local R=$d/RTL
    local SRCS="$R/CPU/CPU_CACHE/CACHE_TAG_ARRAY/CACHE_TAG_ARRAY.sv $R/CPU/CPU_CACHE/CACHE_DATA_ARRAY/CACHE_DATA_ARRAY.sv \
$R/CPU/CPU_CACHE/ICACHE/ICACHE.sv $R/CPU/CPU_CACHE/DCACHE/DCACHE.sv $R/CPU/CPU_CACHE/CACHE_PORT_ARB/CACHE_PORT_ARB.sv $R/CPU/CPU_CACHE/CPU_CACHE/CPU_CACHE.sv \
